    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin: 0px 0px 0px 0px;">
            ...
            <div class="row">
             ...
             <iframe src="https://app.powerbi.com/view?r=eyJrIjoiYTMzNTM0MzMtYjZjMy00ZjU0LWE5ZGQtNWZmMGVmMmEzZDcwIiwidCI6ImYzNGEzNWJkLWE2NWQtNDYwNS1iMGZhLWQyNTcxZjgzMWY1ZSIsImMiOjEwfQ%3D%3D" allowFullScreen="true" style="position:absolute; height:100%; width:100%; border: none" align="center" scrolling="no"></iframe>
                        <div class="pull-right">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">
                                    Drill
